...
struct positionFromLike: View {
    ...
    var uid_pref: String {return "UID"}
...
public func prepareRequestLike(_ method: String, _ url: String, _ body: Data?, account: String, session: String) -> URLRequest?{
    let account = account
    let session = session
